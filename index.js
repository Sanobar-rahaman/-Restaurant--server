...
async function run() {
  try {
    ...
    //store the payment to database
    app.post('/payments',async(req,res)=>{
        const payment = req.body
        // console.log(payment);
        const paymentResult = await paymentCollection.insertOne(payment);

        //careFully delete is item from the cart
        const query ={_id:{
